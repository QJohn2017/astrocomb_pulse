...
z = 10;
alpha = 0.22/1000/4.34;       % Loss coefficient, unit m-1. Leading number is loss in dB/km
%betap = [0, 0, 0.0023, -7.2317e-06]; %Typical HNLF
[beta2, beta3] = D_to_beta(-0.25, 0.006);
betap = [0, 0, beta2, beta3]; %Zero dispersion HNLF
gamma = 10.6*1E-3;
%gamma = 0.78*1E-3;	%Nonlinaer Coefficient of material Taken from https://ieeexplore.ieee.org/document/7764544
fiber_loss = 1;    %Loss after compressor, etc
trans = 1;    %Transmission from lens to waveguide
